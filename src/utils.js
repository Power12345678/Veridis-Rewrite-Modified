...
export function resolveAiModelListBaseUrl(value) {
...
export function normalizePresetAiRewriteSettings(value) {
    ...
    return {
        ...
        promptTemplate: shouldUpgradePromptProtocol
            ? defaultAiRewriteSettings.promptTemplate
            : String(value.promptTemplate || defaultAiRewriteSettings.promptTemplate),
